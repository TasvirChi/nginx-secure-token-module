...
cd /tmp/builddir
wget $NGINX_URI -O borhan-nginx-$NGINX_VERSION.tar.gz
tar zxvf borhan-nginx-$NGINX_VERSION.tar.gz
cd nginx-$NGINX_VERSION

LD_LIBRARY_PATH=/opt/borhan/ffmpeg-2.1.3/lib
LIBRARY_PATH=/opt/borhan/ffmpeg-2.1.3/lib
C_INCLUDE_PATH=/opt/borhan/ffmpeg-2.1.3/include
